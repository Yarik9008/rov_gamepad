...
- **Тип:** Мгновенное переключение
- **Состояния:**
  - Выключено: LIGHT_OFF (1000 PWM)
  - Включено: LIGHT_ON (2000 PWM)
...
### Гибкая конфигурация
- **Поддержка 3, 4, 6, 8 моторов** с различными схемами кинематики
- **Реверс моторов** для каждого движителя отдельно
